...
SPONSOR_V2_DIR_HOST="${SPONSOR_V2_DIR_HOST:-$(dirname "$PROJECT_DIR")/sponsor_norm_v2}"
SUBSTANCE_V2_DIR_HOST="${SUBSTANCE_V2_DIR_HOST:-$(dirname "$PROJECT_DIR")/substance_norm_v2}"
